# Employee-salary-analysis.py
This is a beginner Python data analysis project created using Pandas and Matplotlib.The project analyzes Employess Salary data.
import pandas as pd
